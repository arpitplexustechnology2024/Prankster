...
class VideoCharacterAllVC: UIViewController {
...
extension VideoCharacterAllVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
