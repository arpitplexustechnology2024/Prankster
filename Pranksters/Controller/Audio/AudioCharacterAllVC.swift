...
class AudioCharacterAllVC: UIViewController {
...
extension AudioCharacterAllVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if coverPageData.premium {
            ...
            let vc = storyboard.instantiateViewController(identifier: "AudioPreviewVC") as! AudioPreviewVC
