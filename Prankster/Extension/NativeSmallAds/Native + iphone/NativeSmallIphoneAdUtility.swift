...
class NativeSmallIphoneAdUtility: NSObject {
...
extension NativeSmallIphoneAdUtility: GADAdLoaderDelegate, GADNativeAdLoaderDelegate {
    ...
    func adLoader(_ adLoader: GADAdLoader, didReceive nativeAd: GADNativeAd) {
        ...
        guard
            let nibObjects = Bundle.main.loadNibNamed("NativeSmallIphoneAdView", owner: nil, options: nil),
...
extension NativeSmallIphoneAdUtility: GADNativeAdDelegate {
