...
class NativeSmallIpadAdUtility: NSObject {
...
extension NativeSmallIpadAdUtility: GADAdLoaderDelegate, GADNativeAdLoaderDelegate {
    ...
    func adLoader(_ adLoader: GADAdLoader, didReceive nativeAd: GADNativeAd) {
        ...
        guard
            let nibObjects = Bundle.main.loadNibNamed("NativeSmallIpadAdView", owner: nil, options: nil),
...
extension NativeSmallIpadAdUtility: GADNativeAdDelegate {
