...
class PrankViewModel {
    ...
    func createPrank(coverImage: Data, coverImageURL: String, type: String, name: String, file: Data, fileURL: String, imageURL: String, fileType: String, completion: @escaping (Bool) -> Void) {
        ...
        apiService.createPrank(coverImage: coverImage, coverImageURL: coverImageURL, type: type, name: name, file: file, fileURL: fileURL, imageURL: imageURL, fileType: fileType) { [weak self] result in
            ...
            DispatchQueue.main.async {
                ...
                case .success(let response):
                    ...
                    self.createPrankImage = response.data.image
